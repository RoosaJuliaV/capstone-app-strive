...
<MDBRow className="d-flex flex-row text-center">
      <MDBCol md="3" sm="4" xs="4" className="mr-0">
...
<ul className="loginfooterlist d-flex">
  <li className="loginfootercentertitle mb-4 d-inline">If you are under intensive emotional distress, please reach out to:</li>
