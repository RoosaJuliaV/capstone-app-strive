...
const TopCardMeditate = ({ addToPlaylist, addToCurrentSong }) => {
    ...
    <div>
      <MDBRow>
        {shuffled_array.slice(0, 1).map((track, i) => (
          <MDBCard className="topmeditatecard mb-5 ml-4" key={i}>
...
export default connect(mapStateToProps, mapDispatchToProps)(TopCardMeditate);
